...
st.write("Tanyakan apa saja tentang analis saham  Global dan IDX (teknikal, fundamental, rekomendasi, tren pasar).\n notes: jika saham idx tambahakan (.jk) dibelakang symbol saham")
