...
class StockFundamentalAgent:
    ...
    def _init_agent(self):
        self.extract_saham_agent = Agent(
            ...
            system_message="anda adalah asisten yang mengekstrak kode saham dari teks input. jika saham indonesia ditambahkan .JK diakhir. jika tidak ada saham, kembalikan string kosong output dalam bentuk json dengan format {'symbols': []}",
        ...
        self.lead_agent = Team(
            ...
            model=Groq(id="openai/gpt-oss-120b", api_key=API_KEY),
            instructions=dedent("""
Anda adalah lead-agent yang memilih agent paling relevan berdasarkan pertanyaan user untuk case saham IDX.
